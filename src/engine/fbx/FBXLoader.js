/* Three.js r180 FBXLoader, MIT license. Local fix: synchronize independently keyed rotation axes. */
...
class AnimationParser {
	...
	generateRotationTrack( modelName, curves, preRotation, postRotation, eulerOrder ) {
		...
		if ( curves.x !== undefined && curves.y !== undefined && curves.z !== undefined ) {
			...
			const synced = synchronizeRotationCurves( curves );
			const result = this.interpolateRotations( synced.x, synced.y, synced.z, eulerOrder );
